...
struct EstimatedKeywordDifficultyWorkspaceUITests {
    ...
    @Test
    func missingDetailUsesTheTrackedKeywordScope() throws {
        let container = try ModelContainerFactory.makeModelContainer(isStoredInMemoryOnly: true)
        let view = EstimatedKeywordDifficultyDetailSheet(
            keyword: "focus",
            ...
            summary: nil,
            fallbackStorefront: "Germany",
            fallbackPlatform: .iphone,
            modelContext: ModelContext(container)
        )

        #expect(view.scopeDescription == "Germany · iPhone")
    }
